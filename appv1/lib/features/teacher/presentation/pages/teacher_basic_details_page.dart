...
class TeacherBasicDetailsPage extends StatefulWidget {
  const TeacherBasicDetailsPage({super.key});

  @override
  State<TeacherBasicDetailsPage> createState() => _TeacherBasicDetailsPageState();
}

class _TeacherBasicDetailsPageState extends State<TeacherBasicDetailsPage> {
  bool _loading = true;
  bool _saving = false;
